...
public class HibernateConfig {
	...
	@Value("${jdbc.url}")
	private String DATABASE_URL="jdbc:mysql://localhost:5501/onlineshopping?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
	@Value("${jdbc.driver}")
